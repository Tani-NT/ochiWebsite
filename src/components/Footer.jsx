function Footer() {
  return (
    <div className="w-full h-screen flex gap-[2vw] px-[3vw] max-sm:h-full">
      <div className="w-1/2 max-sm:h-[40vh]  flex flex-col justify-between items-start font-['Founders_Grotesk_X']">
        <div>
            <h1 className="text-[10vw] tracking-tight font-semibold -mb-[8vw]">EYE-</h1>
            <h1 className="text-[10vw] tracking-tight font-semibold -mb-[8vw]">OPENING</h1>
        </div>
      ...
      <div className="w-1/2 font-['Founders_Grotesk_X']">
        <h1 className="text-[10vw] tracking-tight font-semibold -mb-[8vw]">PRESENTATIONS</h1>
        <div className="w-[60vw] flex flex-col text-[1vw] font-['Neue_Montreal'] pt-[5vw]">
            <h1 className="pb-[1.5vw]">S:</h1>
            <a>Instagram</a>
            <a>Facebook</a>
            <a>Youtube</a>
            <a>Twitter</a>
        </div>
        <div className="flex gap-[4vw] font-['Neue_Montreal']">
            <div className="w-[60vw] flex flex-col text-[1vw]  pt-[3.5vw]">
                <h1 className="pb-[1.5vw]">L:</h1>
                <div className="pb-[1.5vw] flex flex-col">
            ...
            <div className="w-[60vw] flex flex-col text-[1vw] pt-[5vw]">
                <h1 className="pb-[1.5vw]">M:</h1>
                <a>Home</a>
                <a>Services</a>
                <a>Our Work</a>
                <a>About us</a>
        ...
        <div className="block font-['Neue_Montreal'] text-[1vw] pt-[1.5vw]">
            <h1 className="pb-[1.5vw]">E:</h1>
